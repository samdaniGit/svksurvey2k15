...
class HoubaseAdmin(admin.ModelAdmin):
	fields=('household', 'household_number', 's_no', 'owned_or_rented', 'year_construction', 'isthere_kitchen', 'noof_additional_rooms', 'type_roof', 'latrine', 'electricity', 'source_energy_cooking_one','source_energy_cooking_two', 'govtscheme_yes_or_no', 'govtscheme_year', 'govtscheme_nature_reimbusment', 'govtscheme_cash', 'value_of_house', 'availbility_safe_drinking_text','does_village_have_safe_waterfacility', 'does_house_have_watertap','isthere_watertap','distance_travelled_water', 'amount_spending_water', 'comments',)
