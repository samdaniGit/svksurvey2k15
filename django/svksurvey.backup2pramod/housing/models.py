...
class Houbase(models.Model):
	...
	isthere_watertap =  models.ForeignKey(Yesorno, related_name = "isthere-watertap")
	def __str__(self):
...
class Indebtedness(models.Model):
	...
	loan_no = models.ForeignKey(Numbers, related_name = "loan_no", verbose_name = u'ఋణ సంఖ్య ')
...
class Selfhelpgroups(models.Model):
	...
	savings_total = models.FloatField(verbose_name=u'మొత్తం ')
...
class Assets(models.Model):
	...
	electronics_dish_value = models.FloatField(verbose_name= u'డిష్ ఆంటెన్నా విలువ')
	...
	investments_bonds_no = models.ForeignKey(Numbers, related_name = "investments_bonds_no", verbose_name= u'బాండ్లు సంఖ్య')
