...
class Expmonthly(models.Model):
	...
	expendicture_year = models.FloatField()
...
class Exphealth(models.Model):
	...
	expendutre_morgaging_selling_land = models.ForeignKey(Yesorno, related_name = "expendutre_morgaging_selling_land")
	expendutre_morgaging_selling_gold = models.ForeignKey(Yesorno, related_name = "expendutre_morgaging_selling_gold")
	others = models.CharField(max_length=255)
	cost_of_treatment = models.FloatField(verbose_name= u'అయిన ఖర్చు ')
	expendutre_loan_landlord = models.ForeignKey(Yesorno, related_name = "expendutre_loan_landlord")
...
class Migration(models.Model):
	...
	shortterm_from = models.CharField(max_length=255,verbose_name= u'స్వల్పకాలిక వలసలు నెలలు_వరకు ')
	household = models.ForeignKey(Base,)
