...
class LandleasedoutAdmin(admin.ModelAdmin):
	fields=('household','household_number','leaseout_or_not','landtype','extent','landtenant_name','landtenant_caste','landtenant_occupation','landtenant_extent_landholding','tenurial_registration','tenurial_contracttype','tenurial_sincewhen','annual_fixedrent_cash','annual_fixedrent_kind','loan_fromyou_withinterest','loan_fromyou_interestfree','qty_hay_bytenant','input_you_manure','input_you_fertiliser','input_you_seed','input_you_pesticide','input_you_electricity','input_you_pumpset','input_you_machinary',)
admin.site.register(Landleasedout,LandleasedoutAdmin)

class MortgagedinAdmin(admin.ModelAdmin):
	fields=('household','household_number','mortgagedin_or_not','landtype','extent','businessman_name','businessman_caste','businessman_occupation','year_mortgage','mortgage_period','mortgage_amount','interest',)
admin.site.register(Mortgagedin,MortgagedinAdmin)

class MortgagedoutAdmin(admin.ModelAdmin):
	fields=('household','household_number','mortgagedout_or_not','landtype','extent','mortgagee_name','mortgagee_caste','mortgagee_occupation','year_mortgage','mortgage_period','mortgage_amount','interest',)
...
class InterlinksAdmin(admin.ModelAdmin):
	fields=('household','household_number','inputs_labour','inputs_commodity','inputs_land','inputs_loans','loans_labour','loans_commodity','loans_land','land_labour','land_commodity','comodity_labour',)
