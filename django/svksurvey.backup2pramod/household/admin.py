...
class BaseAdmin(admin.ModelAdmin):
	fields=('village','household_number','name_of_household','sex','age','caste','scorst','tehisil_of_birth','mandal','year_migration','father_name','father_occupation','religion','district','address','phone',)
admin.site.register(Base,BaseAdmin)

class HhmembersAdmin(admin.ModelAdmin):
	fields=('household', 'household_number', 'name', 'sex', 'age', 'relationship_to_head', 'marital_status', 'occupations_one', 'place_of_work_one', 'occupations_two', 'place_of_work_two', 'occupations_three', 'place_of_work_three' , 'literary_status', 'education_level', 'name_location_institute',)
