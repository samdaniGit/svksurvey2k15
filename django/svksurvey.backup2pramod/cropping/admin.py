...
class ProductionsalesAdmin(admin.ModelAdmin):
	fields=('household','household_number', 'produced','s_no','crop','tenurial_status','extent','month_sowing','month_harvesting','source_irrigation','production_grain','production_straw','household_consumpion_grain','household_consumption_straw','sale_month_disposal','sale_quantity','sale_price','sale_where_marketed','sale_marketing_agency','sale_transport_mode','sale_transport_cost','sale_other_marketing_costs','sale_wasthe_price_fixedbefore','sale_by_products_price','sale_by_products_amt','income_oncrop','income_on_products','total_income','market_expense','net_income',)
admin.site.register(Productionsales,ProductionsalesAdmin)

class InputsAdmin(admin.ModelAdmin):
	fields=('household','household_number','inputs_used','s_no','crop','manure_type_one', 'manure_home_qty_one', 'manure_home_value_one', 'manure_home_cost_one', 'manure_type_two', 'manure_home_qty_two', 'manure_home_value_two', 'manure_home_cost_two', 'manure_type_three', 'manure_home_qty_three', 'manure_home_value_three', 'manure_home_cost_three', 'manure_type_four', 'manure_home_qty_four', 'manure_home_value_four',	'manure_home_cost_four', 'manure_purchased_type_one', 'manure_purchased_cost_one' , 'manure_purchased_price_one', 'manure_purchased_qty_one', 'manure_purchased_type_two', 'manure_purchased_cost_two', 'manure_purchased_price_two', 'manure_purchased_qty_two', 'manure_purchased_type_three', 'manure_purchased_cost_three', 'manure_purchased_price_three', 'manure_purchased_qty_three', 'manure_purchased_type_four', 'manure_purchased_cost_four', 'manure_purchased_price_four', 'manure_purchased_qty_four' ,'manure_transport_mode','manure_transport_costincurred','fertiliser_type_one', 'fertiliser_qty_one','fertiliser_cost_one', 'fertiliser_type_two', 'fertiliser_qty_two','fertiliser_cost_two', 'fertiliser_type_three', 'fertiliser_qty_three','fertiliser_cost_three', 'fertiliser_type_four', 'fertiliser_qty_four','fertiliser_cost_four',  'fertiliser_type_five', 'fertiliser_qty_five','fertiliser_cost_five', 'fertiliser_type_six', 'fertiliser_qty_six','fertiliser_cost_six', 'fertiliser_type_seven', 'fertiliser_qty_seven', 'fertiliser_cost_seven', 'fertiliser_type_eight', 'fertiliser_qty_eight','fertiliser_cost_eight', 'fertiliser_transport_mode','fertiliser_transport_costincurred','seeds_home_qty','seeds_home_value','seeds_home_cost','seeds_purchased_qty','seeds_purchased_price','seeds_purchased_cost','plant_protection_value','irrigation_charges_source','irrigation_charges_price','irrigation_charges_totalcost','advice_regarding_cultivation',)
admin.site.register(Inputs,InputsAdmin)

class SpecifiedproductionAdmin(admin.ModelAdmin):
	fields=('household','household_number','implements_owned','itemcode','ownership_number','ownership_yearpurchase','ownership_pricepaid_perunit','ownership_subsidy_received','ownership_presentvalue','maintenance_charges_lastyear','rental_earnings_units','rental_earnings','total_earnings','comments',)
...
class LongtermworkerAdmin(admin.ModelAdmin):
	fields=('household','household_number','workedas_longtermworker','name_worker','name_manager','caste_worker','caste_manager','occupation_manager','land_owned','land_leasedin_mortin','land_leasedout_mortout','other_business_activities','tasks_performed_one','tasks_performed_two','tasks_performed_three','number_months','earning_cash','earning_kind','total','get_number_days_off','working_from','working_to','illness_get_help','illness_get_help_text','subjected_harassments','subjectd_harassments_describe',)
