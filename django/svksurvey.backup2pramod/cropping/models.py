...
class Productionsales(models.Model):
	...
	market_expense = models.FloatField(null=True, blank=True)
	...
	income_oncrop = models.FloatField(null=True, blank=True)
	...
	income_on_products = models.FloatField(null=True, blank=True)
...
class Inputs(models.Model):
	...
	seeds_home_value = models.FloatField(null=True, blank=True,)
	...
	seeds_purchased_cost = models.FloatField(null=True, blank=True,)
	...
	advice_regarding_cultivation = models.CharField(max_length=255,null=True, blank=True,)
	irrigation_charges_totalcost = models.FloatField(null=True, blank=True,)
	...
	seeds_home_cost = models.FloatField(null=True, blank=True,)
	...
	fertiliser_price = models.FloatField(null=True, blank=True,)

	fertiliser_type_one = models.ForeignKey(Fertilisertype,null=True, blank=True, related_name = "fertiliser_type_one")
	fertiliser_cost_one = models.CharField(max_length=255,null=True, blank=True,)
	...
	fertiliser_cost_two = models.CharField(max_length=255,null=True, blank=True,)
	...
	fertiliser_cost_three = models.CharField(max_length=255,null=True, blank=True,)
	...
	fertiliser_cost_four = models.CharField(max_length=255,null=True, blank=True,)
	...
	fertiliser_cost_five = models.CharField(max_length=255,null=True, blank=True,)
	...
	fertiliser_cost_six = models.CharField(max_length=255,null=True, blank=True,)
	...
	fertiliser_cost_seven = models.CharField(max_length=255,null=True, blank=True,)
	...
	fertiliser_cost_eight = models.CharField(max_length=255,null=True, blank=True,)
	...
	manure_home_value_one = models.CharField(max_length=255,null=True, blank=True,)
	manure_home_cost_one = models.CharField(max_length=255,null=True, blank=True,)
	...
	manure_home_value_two = models.CharField(max_length=255,null=True, blank=True,)
	manure_home_cost_two = models.CharField(max_length=255,null=True, blank=True,)
	...
	manure_home_value_three = models.CharField(max_length=255,null=True, blank=True,)
	manure_home_cost_three = models.CharField(max_length=255,null=True, blank=True,)
	...
	manure_home_value_four = models.CharField(max_length=255,null=True, blank=True,)
	manure_home_cost_four = models.CharField(max_length=255,null=True, blank=True,)
	manure_purchased_type_one = models.ForeignKey(Manuretype,null=True, blank=True, related_name = "manure_purchased_type_one")
	manure_purchased_cost_one = models.CharField(max_length=255,null=True, blank=True,)
	...
	manure_purchased_cost_two = models.CharField(max_length=255,null=True, blank=True,)
	...
	manure_purchased_cost_three = models.CharField(max_length=255,null=True, blank=True,)
	...
	manure_purchased_cost_four = models.CharField(max_length=255,null=True, blank=True,)
...
class Specifiedproduction(models.Model):
	...
	total_earnings = models.FloatField(null=True, blank=True,verbose_name=u'నికరాదాయం ')
...
class Managerpayments(models.Model):
	...
	def __str__(self):
                return str(self.payments_incash)
...
class Longtermworker(models.Model):
	...
	land_leasedin_mortin = models.FloatField(null=True, blank=True,verbose_name=u'భూమి కౌలుకు ఇచ్చినది ')
	...
	caste_worker = models.ForeignKey(Caste,null=True, blank=True, related_name = "caste_worker", verbose_name=u'పాలేరు కులం  ')
	...
	land_leasedout_mortout = models.FloatField(null=True, blank=True,verbose_name=u'భూమి కౌలుకు తీసుకునది ')
